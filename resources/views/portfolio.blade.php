  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="col">
        <a href="/portfolio/project">
          <div class="card">
            <img src="{{ asset('show/show1-2.jpg') }}" class="card-img-top card-show" alt="...">
            <div class="show-me text-secondary p-3">台南市南區 老宅翻新</div>
          </div>
        </a>
      </div>
      <div class="col">
        <a href="/portfolio/project">
          <div class="card">
            <img src="{{ asset('show/show1-3.jpg') }}" class="card-img-top card-show" alt="...">
            <div class="show-me text-secondary p-3">台南市南區 老宅翻新</div>
          </div>
        </a>
      </div>
      <div class="col">
        <a href="/portfolio/project">
          <div class="card">
            <img src="{{ asset('show/show1-4.jpg') }}" class="card-img-top card-show" alt="...">
            <div class="show-me text-secondary p-3">台南市南區 老宅翻新</div>
          </div>
        </a>
      </div>
      <div class="col">
        <a href="/portfolio/project">
          <div class="card">
            <img src="{{ asset('show/show1-5.jpg') }}" class="card-img-top card-show" alt="...">
            <div class="show-me text-secondary p-3">台南市南區 老宅翻新</div>
          </div>
        </a>
      </div>
      <div class="col">
        <a href="/portfolio/project">
          <div class="card">
            <img src="{{ asset('show/show1-6.jpg') }}" class="card-img-top card-show" alt="...">
            <div class="show-me text-secondary p-3">台南市南區 老宅翻新</div>
          </div>
        </a>
      </div>
